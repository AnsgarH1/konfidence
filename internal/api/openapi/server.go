...
type ListLandscapes404JSONResponse struct{ NotFoundJSONResponse }

func (response ListLandscapes404JSONResponse) VisitListLandscapesResponse(w http.ResponseWriter) error {
